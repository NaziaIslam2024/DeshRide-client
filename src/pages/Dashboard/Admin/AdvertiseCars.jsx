    ...
    const handleAdvertiseToggle = async (carId, advertiseStatus) => {
        try {
            ...
            setCars(cars.map(car =>
                car._id === carId ? { ...car, advertiseStatus: advertiseStatus ? 'Active' : 'Inactive' } : car
            ));
            toast.success(`Car advertisement ${advertiseStatus ? 'enabled' : 'disabled'} successfully!`);
        } catch (err) {
                    ...
                    <table className="min-w-full">
                        <thead className="bg-gradient-to-r from-gray-800 to-gray-700 text-white">
                            <tr>
                                ...
                                <th className="py-4 px-6 text-left font-semibold">Advertise Status</th>
                                    ...
                                    <td className="py-4 px-6">
                                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                                            ...
                                            <span className={`w-2 h-2 rounded-full mr-2 ${
                                                car.advertiseStatus === 'Active' ? 'bg-green-500' : 'bg-red-500'
                                            }`}></span>
                                            {car.advertiseStatus === 'Active' ? 'Advertised' : 'Not Advertised'}
                                        </span>
                                    </td>
                                    <td className="py-4 px-6">
