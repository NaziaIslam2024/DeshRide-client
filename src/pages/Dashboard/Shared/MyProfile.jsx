...
import { FaCar, FaIdCard, FaPhone, FaHome, FaUserShield, FaTools, FaShieldAlt, FaUserTie, FaUser } from 'react-icons/fa';
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="bg-white p-8 rounded-xl shadow-lg max-w-md text-center">
          ...
          <p className="text-gray-600 mb-6">We couldn't find any profile data for your account.</p>
        </div>
      </div>
    );
  }
        ...
        <div className={`bg-gradient-to-r ${roleDetails.color} rounded-3xl shadow-xl overflow-hidden mb-8`}>
          <div className="p-8 md:p-12 flex flex-col md:flex-row items-center">
            ...
            <div className="text-center md:text-left">
              <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">{profileData.fullName}</h1>
              <div className="inline-block bg-white/20 backdrop-blur-sm px-4 py-1 rounded-full mb-4">
                <span className="text-white font-semibold">{profileData.role}</span>
              </div>
              <p className="text-white/90 max-w-lg">{roleDetails.description}</p>
            </div>
          </div>
        </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-800">{profileData.emergencyContact || 'Not provided'}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="p-6 space-y-4">
                ...
                <>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-800">You can offer various services</p>
                    </div>
                  </div>
                </>
              )}
              ...
              {profileData.role === 'consumer' && (
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">Service Consumer</p>
                    <p className="text-gray-800">You can book and request services</p>
                  </div>
                </div>
              )}

              {(profileData.role === 'driver' || profileData.role === 'ownerDriver') && (
                <div className="flex items-start">
                  <div className="bg-purple-100 p-3 rounded-full mr-4">
              ...
              {(profileData.role === 'providerOnly' || profileData.role === 'ownerDriver') && (
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">Service Provider</p>
                    <p className="text-gray-800">You can offer services to users</p>
                  </div>
                </div>
              )}
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">{profileData.vehicleDetails || 'Not specified'}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">{profileData.vehicleModel || 'Not specified'}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">{profileData.vehicleType || 'Not specified'}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">{profileData.carUsage || 'Not specified'}</p>
                  </div>
                </div>
              </div>
            </div>
